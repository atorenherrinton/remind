...
describe("Main", () => {
	...
	it("clicking the icon button collapses the navigation drawer", () => {
		store.dispatch(setUid("uP0PcYMj5geFKrFWR8QPE8ON80E2"));
		userEvent.click(screen.getByRole("icon-button"));
		expect(screen.getByRole("drawer").firstElementChild).toHaveStyle("transform: translateX(-NaNpx);");
	});
